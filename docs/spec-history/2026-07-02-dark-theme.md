...
## 완료 조건
- [x] 모든 구현 단위 verify 통과 (`tsc --noEmit`, `pnpm -C app test`)
- [x] Q1/Q2/Q3 QA 통과 (라이트/다크 양쪽 시각 검증)
- [x] 프로젝트 커스텀 컴포넌트 `dark:` 프리픽스 0개
- [x] `docs/decisions.md` 갱신 (단위 17)
- [x] `docs/backlog.md` "다크 테마 추가" 항목 체크
- [x] `spec-current.md` → `docs/spec-history/2026-07-02-dark-theme.md` 이관 준비
