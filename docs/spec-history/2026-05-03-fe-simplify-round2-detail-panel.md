...
- [x] `app/src/components/base/FullScreenPanel.tsx` 에 `useStaggeredPanel<T>` 훅 추가 + export
- [x] `app/src/components/panels/DetailPanelProvider.tsx` 리팩터 — state 2 중화 + Wrapper/Content 분할
