...
- [x] `routers/trades.py:106` OR 분기를 strict 비교로 변경.
- [x] `tests/test_trades.py` 에 strict 회귀 테스트 추가 (asset_name 만 일치하는 row 제외).
- [x] 백엔드 테스트 실행 (`cd api && poetry run pytest tests/test_trades.py -q`).
- [x] `docs/backlog.md` 해당 항목 체크/제거.
- [x] `docs/decisions.md` 2026-04-30 항목에 trades.py 정리 한 줄 추가.
