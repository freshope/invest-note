...
- [x] `api/src/invest_note_api/utils/__init__.py` 신규
- [x] `api/src/invest_note_api/utils/numbers.py` 신규: `strip_comma_number`
- [x] `api/tests/test_utils_numbers.py` 신규: 단위 테스트
- [x] `schemas/trade.py` 리팩터
- [x] `schemas/account.py` 리팩터
- [x] `broker_import/base.py` 리팩터
- [x] `cd api && poetry run pytest -q` 전체 통과
