...
| v2.5 | 소셜 로그인 (Google/Kakao/Apple), FastAPI 백엔드 분리, Capacitor 모바일앱 (iOS/Android) | 🚧 진행 중 (P1-P3 + Chunk A 클라이언트 컷오버 + Chunk D 정적 export 전환 + Capacitor 셋업/iOS·Android 플랫폼 생성 완료 — FastAPI 배포·OAuth deep link·스토어 심사 대기) |
| v2 | KIS API 자동 연동 | 예정 |
