...
- [ ] `supabase/migrations/017_backfill_sell_result_from_pnl.sql` 생성
- [ ] `api/src/invest_note_api/routers/trades.py` fallback 제거 및 미사용 import 정리
- [ ] 백엔드 테스트 통과 확인 (`cd api && poetry run pytest -q`)
- [ ] `docs/backlog.md` 해당 항목 제거 (spec-finish 시점)
