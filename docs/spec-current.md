...
- [ ] A1~A5, B1~B5, C1~C4, D1 전 단위 verify 통과.
- [ ] QA-BE / QA-FE-panels / QA-integration 통과.
- [ ] 기술 결정(트레이드오프) 없음 → `docs/decisions.md` 갱신 불필요(필요 판단 시 추가).
- [ ] spec → `docs/spec-history/YYYY-MM-DD-settings-restructure-board-endpoints.md` 이동 준비.
