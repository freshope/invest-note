...
- [ ] `ImportTradesPanel/index.tsx` 에 `getInitialSelectedAccountId` 헬퍼 추가 + `useState` lazy initializer 적용
- [ ] `AccountStep.tsx` 에서 useEffect / useMemo / 관련 import 제거
- [ ] `__tests__/ImportTradesPanel.test.tsx` 신규 작성 (5 시나리오: eligible 0 / 1 / 2+ / ineligible 만 / 혼합)
- [ ] `docs/backlog.md` 의 해당 항목 제거
