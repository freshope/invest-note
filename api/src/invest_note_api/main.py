...
from invest_note_api.routers import accounts, admin, admin_board, app_config, auth, board, health, live_update, me, notifications
...
def create_app(settings: Settings | None = None) -> FastAPI:
    ...
    # 앱(인증) 라우터 — 정식 경로는 /v1/*.
    app_routers = (me.router, accounts.router, trades.router, portfolio.router, stocks.router, analysis.router, assets.router, board.router, notifications.router)
