...
export function TradeFormPanel({ open, onOpenChange, accounts, prefillStock, prefillTradeType, prefillAccountId, source }: TradeFormPanelProps) {
  ...
  const [tradeType, setTradeType] = useState<TradeType>(prefillTradeType ?? TRADE_TYPE.BUY);
        ...
        <FullScreenPanelBody>
          {step === "basic" && (
            <TradeBasicForm
              ...
              prefillTradeType={prefillTradeType}
