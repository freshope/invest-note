...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorFirebaseMessaging", path: "../../../../node_modules/.pnpm/@capacitor-firebase+messaging@8.3.0_@capacitor+core@8.3.1_firebase@12.16.0/node_modules/@capacitor-firebase/messaging"),
